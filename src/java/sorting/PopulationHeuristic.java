...
//                    if(!numbers.contains(temp.getList().get(i).getNumber())){
//                        numbers.add(temp.getList().get(i).getNumber());
//                    }
//                }
//		if(numbers.size()!= 15){
...
//                }
    ...
    public Solution uniformCrossover(Solution one, Solution two) {
        ...
        while (i < one.getList().size()) {
            ...
            if (index) {
                Aircraft cand = null;
                for (Aircraft air : one.getList()) {
                    if (air.getNumber() == i) {
                        cand = air;
                    }
                }
                temp.getList().add(cand);
            } else {
                Aircraft cand = null;
                for (Aircraft air : two.getList()) {
                    if (air.getNumber() == i) {
                        cand = air;
                    }
                }
